...
/**
 * Class responsible for realization of uploads in the system Easy Lab
 * Correction. <br>
 * 
...
public class ServletUpload extends HttpServlet {
	...
	public static final String local2 = "C:" + File.separator +
	...
	/**
	 * Method that decompresses the file received as parameter in the
	 * destination folder chosen.<br>
	 * 
	 * @param destinationFolder
	 *            - the destination folder of files uncompressed.<br>
	 * @param fileName
	 *            - the file name.<br>
	 * @throws IOException
	 *             - exception that can be caused in an attempt to decompress
	 *             the file.<br>
	 */
	public static void unZip(String destinationFolder, String fileName)
			throws IOException {
		...
		try {
			...
			if (!dir.exists() || !dir.isDirectory()) {
				throw new IOException("O diretÛrio " + dir.getName()
						+ " n„o È um diretÛrio v·lido");
			}
	 ...
	 * 
	 * @param request
	 *            - the request used to download files.<br>
	 * @param response
	 *            - the response of the request.<br>
	 * @throws ServletException
	 *             - exceptions caused in the use of the servlet.<br>
	 * @throws IOException
	 *             - exceptions caused for problems of the input and/or output.<br>
	 */
	protected void downloadArchive(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
	...
	/*
	 * protected void fazUploadUnZip(HttpServletRequest request,
	 * HttpServletResponse response) throws ServletException, IOException {
	 * fazUpload(request, response); unZip(out); }
	 */
	...
	protected void makesUpload(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			List<FileItem> fileItems = (List<FileItem>) uploadParser
					.parseRequest(request);
			// Tive de iterar nos FileItem pra saber o fieldName chamado
			// Filedata,
