...
import br.edu.les.easyCorrection.excepetions.AtributoNaoExisteExeption;
import br.edu.les.easyCorrection.excepetions.EasyCorrectionException;

public class SwapperAtributosReflect {

	/**
	 * Copia os atributos de um objeto (objAtributosACopiar) para um outro (objetoOriginal), exceto o Id do Objeto
	 * que � formado por idNomedaClasse e o serialVersionUID . 
	 * A copia dos atributos � realizada tamb�m com os atributos da superclasse 
	...
	public static Object swapObject(Object objetoOriginal,
			Object objAtributosACopiar, Class classe) throws EasyCorrectionException {
		return swapObject(objetoOriginal, objAtributosACopiar,true, classe);
	}
	
	/**
	 * Permite tb Verifica ou desconsiderar os metodos da classe  os metodos da classe pai
	 * @param objetoOriginal
	 * @param objAtributosACopiar
	 * @param classePai
	 * @param classe
	...
	@SuppressWarnings("unchecked")
	public static Object swapObject(Object objetoOriginal,
			Object objAtributosACopiar,boolean classePai, Class classe) throws EasyCorrectionException {
		...
		//adicionar os metodos da superclass
			if(classePai){
				...
				declaredMetodos.addAll(Arrays.asList(superClasse.getDeclaredMethods()));
			}
			...
			for(Field atributo: fields){
				...
				if(!restricoesAtributos.contains(nomeAtributo)){
					Object valorAtributo = getAtributo(objAtributosACopiar, nomeAtributo, atributo.getType());
					
					setAtributo(objetoOriginal,getMetodoSetDoAtributo(nomeAtributo, declaredMetodos),valorAtributo);
	...
	/**
	 * retorna um metodo contido em um array de metodos cujo nome � "set"+nomeAtributo
	 * @param nomeAtributo
	...
	public static Object getAtributo(Object objeto, String atributo, Class<?> type) throws AtributoNaoExisteExeption {
	...
	public static void setAtributo(Object objeto, Method metodo, Object value) throws EasyCorrectionException {
		try {
			metodo.invoke(objeto, value);
		} catch (InvocationTargetException e) {
			throw new EasyCorrectionException(e.getCause().getMessage());
		} catch (Exception e) {
			throw new AtributoNaoExisteExeption(MsgErros.ATRIBUTO_INVALIDO.msg(metodo.getName()));
		}
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static void setAtributo(Object objeto, String atributo, Object value, Class classeValorObjeto) throws EasyCorrectionException {
		Method m;
		try {
			m = objeto.getClass().getDeclaredMethod("set" + corrigeStringAtributo(atributo),classeValorObjeto);
...
/*
	public static void main(String[] args) {
		try {
			//swapObject(new Professor(), new Professor(), Professor.class);
			//swapObject(new Bolsista(), new Bolsista(), Bolsista.class);
			swapObject(new ComiteExterno(), new ComiteExterno(), ComiteExterno.class);
		} catch (EPibicException e) {
