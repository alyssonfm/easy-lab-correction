...
CREATE TABLE `equipe_has_usuario_has_roteiro` (  `equipe_id` int(10) unsigned NOT NULL DEFAULT '0', `usuario_id` int(10) unsigned NOT NULL DEFAULT '0', `roteiro_id` int(10) unsigned NOT NULL DEFAULT '0', `corretor_id` int(10) unsigned NOT NULL DEFAULT '0', `id` int(10) unsigned NOT NULL AUTO_INCREMENT, PRIMARY KEY (`id`), UNIQUE KEY `Index_equipe_usuario_roteiro` (`equipe_id`,`usuario_id`,`roteiro_id`, `corretor_id`), KEY `FK_equipe_has_usuario_has_roteiro_usuario` (`usuario_id`), KEY `FK_equipe_has_usuario_has_roteiro_roteiro` (`roteiro_id`), CONSTRAINT `FK_equipe_has_usuario_has_roteiro_equipe` FOREIGN KEY (`equipe_id`) REFERENCES `equipe` (`id`), CONSTRAINT `FK_equipe_has_usuario_has_roteiro_roteiro` FOREIGN KEY (`roteiro_id`) REFERENCES `roteiro` (`id`), CONSTRAINT `FK_equipe_has_usuario_has_roteiro_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`)), CONSTRAINT `FK_equipe_has_usuario_has_roteiro_corretor` FOREIGN KEY (`corretor_id`) REFERENCES `usuario` (`id`)) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
