...
CREATE TABLE `avaliacao` (
  ...
  KEY `FK_avaliacao_usuario` (`corretor_id`) USING BTREE,
  CONSTRAINT `avaliacao_ibfk_1` FOREIGN KEY (`submissao_id`) REFERENCES `submissao` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_avaliacao_corretor` FOREIGN KEY (`corretor_id`) REFERENCES `usuario` (`id`)
...
INSERT INTO `avaliacao` (`id`,`submissao_id`,`nota_automatica`,`nota_correcao`,`resultado_execucao_testes`,`penalidade`,`data_avaliacao`,`corretor_id`,`corrigido`) VALUES 
 (1,123,'3.30','0.00','Relatório de Avaliação: \n\nTotal de Testes: 3\nTotal de Erros: 2\nPorcentagem de Acertos: 33 %\nNota dos Testes Automáticos: 3.3\n\nConsole:\ntesteIntervalosValidos(TestaSomador): Somatorio errado expected:<0> but was:<5>\ntesteIntervalosInvalidos(TestaSomador): Somatorio errado expected:<-1> but was:<0>\n','0.00','2011-02-17 00:00:00',4,1);
...
CREATE TABLE `equipe` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
...
CREATE TABLE `submissao` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=124 DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
...
INSERT INTO `submissao` (`id`,`url`,`estado`,`data_submissao`,`equipe_has_usuario_has_roteiro_id`) VALUES 
 (113,'/periodo2010.2/submissoes/roteiro_51/Equipe 1/',NULL,'2011-02-17 00:00:00',33),
 (121,'/periodo2010.2/submissoes/roteiro_51/Equipe 1/',NULL,'2011-02-17 00:00:00',33),
 (123,'/periodo2010.2/submissoes/roteiro_51/Equipe 1/',NULL,'2011-02-17 00:00:00',33);
...
INSERT INTO `usuario` (`id`,`login`,`nome`,`senha`,`email`,`periodo_id`) VALUES 
 (1,'demas','Demetrio Gomes','4297f44b13955235245b2497399d7a93','demetri@gmail.com',NULL),
